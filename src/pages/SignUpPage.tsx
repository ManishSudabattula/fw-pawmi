...
const SignUpPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="text-center text-sm text-gray-600">
              ...
              <div className="flex justify-center space-x-4">
                <button
                  type="button"
                  className="flex items-center justify-center w-full border border-gray-300 rounded-md py-2 px-4 hover:bg-gray-50"
                >
      ...
      {/* Right side - Image */}
      <div className="hidden md:block md:w-1/2 bg-cover bg-center" style={{ backgroundImage: `url('/lovable-uploads/3ef3b678-8c04-422b-8c60-247504a2b38b.png')` }}>
